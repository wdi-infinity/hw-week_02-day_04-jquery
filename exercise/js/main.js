...
/**
 * Question 1:
 * When, button 1 is clicked, select all paragraphs on the 
 * page with jQuery, and changed the font color to blue.
 * We've started you off,
 *  ONLY replace everything instance of "replaceMe" with correct code.
 */
...
/**
 * Question 6:
 * When button 2 is clicked, change the html content of all "blockquotes" to 
 * be "<span>no quote</span>"
 */
function question6(){
...
/**
 * Question 9:
 * When button 3 is clicked, select all paragraphs on the page and 
 * change the color to blue and font to Georgia.
 */
function question9(){
	$("p").css("font", "Georgia");
	$("p").css("color", "blue");
...
/**
 * Question 10:
 * Try to do Question 9 but with only one jQuery 
 * call. $("selector").css({attribute: "value", attribute: "value"})
 */
