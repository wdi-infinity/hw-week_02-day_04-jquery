...
$("#button2").on("click", changeToGreen)
 ...
 */
 ...
 $('#button3').on('click', changeToNinja)
 ...
 */
 ...
 function chnageBlueGeorgia () {
	 $('p').css('color', 'blue')
	 $('p').css('font-family', 'Georgia')
 }

 $('#button3').on('click', chnageBlueGeorgia)
